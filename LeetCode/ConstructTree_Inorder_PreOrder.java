package LeetCode;// Java program to construct a tree using inorder and preorder traversal
import java.util.*;

//https://www.geeksforgeeks.org/construct-tree-from-given-inorder-and-preorder-traversal/

class ConstructTree_Inorder_PreOrder {
	...
	{
		ConstructTree_Inorder_PreOrder tree = new ConstructTree_Inorder_PreOrder();
